...
export function Waves({
    className = "",
    strokeColor = "rgba(255, 255, 255, 0.2)",  // Subtle white lines for background
    backgroundColor = "transparent",  // Transparent so underlying background shows through, or dark
    pointerSize = 0.5
}: WavesProps) {
    ...
    const setLines = () => {
        ...
        const yGap = 12  // Vertical spacing
